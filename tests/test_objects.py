...
import txmongo2
from txmongo2 import database
from txmongo2 import collection
from txmongo2 import gridfs
from txmongo2 import filter as qf
from txmongo2._gridfs import GridIn
...
class TestMongoObjects(unittest.TestCase):
    ...
    def test_MongoObjects(self):
        ...
        conn = yield txmongo2.MongoConnection(mongo_host, mongo_port)
        mydb = conn.mydb
...
class TestGridFsObjects(unittest.TestCase):
    """ Test the GridFS operations from txmongo2._gridfs """
    @defer.inlineCallbacks
